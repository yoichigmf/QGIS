...
void QgsContextHelp::init()
{
  ...
  gContextHelpTexts.insert( "PythonConsole", QCoreApplication::translate( "context_help", "<style>\n"
"	#toolbarConsole td{\n"
"		background: #f6f6f6;\n"
"	}\n"
"</style>\n"
...
"") );
  gContextHelpTexts.insert( "SaNewConnection", QCoreApplication::translate( "context_help", "<h3>Create a New SQL Anywhere Connection</h3>\n"
...
"</ol>\n"
"") );
  gContextHelpTexts.insert( "QgsDecorationCopyrightDialog", QCoreApplication::translate( "context_help", "<h3>Copyright Label Plugin</h3>\n"
...
"</ul>\n"
"") );
  gContextHelpTexts.insert( "HeatmapGui", QCoreApplication::translate( "context_help", "<h1>Heatmap Plugin Help</h1>\n"
...
"") );
  gContextHelpTexts.insert( "SaSourceSelect", QCoreApplication::translate( "context_help", "<h3>Add SQL Anywhere Tables</h3>\n"
...
"Ticking <label>Search options</label> enables additional options for searching in different column types and using 2 search modes: <label>Wildcard</label> or <label>RegExp</label>.\n"
"") );
  gContextHelpTexts.insert( "QgsPgNewConnection", QCoreApplication::translate( "context_help", "<h3>Create a New PostgreSQL Connection</h3>\n"
...
"") );
  gContextHelpTexts.insert( "MapServerExport", QCoreApplication::translate( "context_help", "<h3>Export a QGIS Project to MapServer Map File</h3>\n"
"<p>\n"
...
"</table>\n"
"") );
  gContextHelpTexts.insert( "QgsPluginInstallerDialog", QCoreApplication::translate( "context_help", "<h3>Python Plugin Installer</h3>\n"
